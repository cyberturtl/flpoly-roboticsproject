...
We suggest that you review that page to get the necessary files for the robotic arm along with a guide on how to assemble it hassle-free. Any information that we thought necessary to mention about the setup procedure and the project is discussed in our report. 
